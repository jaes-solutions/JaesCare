      ...
      <div className="lg:ml-[245px] min-h-screen">
        ...
        >
          <div className="max-w-5xl mx-auto">
            ...
            <section className="bg-white dark:bg-[#11161d] border border-black/10 dark:border-white/[0.06] rounded-[24px] p-7 mb-6 shadow-sm backdrop-blur-sm">
            ...
            {/* 9. Staff Declaration */}
            <section className="bg-white dark:bg-[#11161d] border border-black/10 dark:border-white/[0.06] rounded-[24px] p-7 mb-32 shadow-sm backdrop-blur-sm">
            ...
            {/* Sticky Footer */}
            <div className="sticky bottom-0 mt-8 bg-white dark:bg-[#11161d] border border-black/10 dark:border-white/[0.06] rounded-[24px] p-5 backdrop-blur-sm">
